  ...
  template: `
    ...
    <div class="card mb-4 bg-base-100">
      <div class="card-body p-4">
        <button appButton variant="ghost" class="self-start" (click)="toggleCreate()">
        ...
        @if (createOpen()) {
          ...
          >
            ...
            <button
              ...
              type="submit"
              [loading]="busy()"
              [disabled]="newFirstName.value.trim().length === 0"
            >
              Create customer
            </button>
          </form>
          ...
          <div class="card bg-base-100">
            <div class="card-body p-4">
              <div class="flex flex-wrap items-center gap-3">
                ...
                >
                  <app-money [cents]="c.ar_balance" /> owed
                </span>
              </div>
                      ...
                      @for (o of orders(); track o.id) {
                        ...
                        @if (repayFor() === o.id) {
                          ...
                          >
                            ...
                            <button appButton variant="ghost" type="button" (click)="repayFor.set(null)">
                              Cancel
                            </button>
                          </form>
                        }
