    ...
    @if (rendered()) {
      <div class="fixed inset-0 z-[60]">
        ...
        <section
          ...
          tabindex="-1"
          class="console-drawer absolute inset-y-0 right-0 flex w-full flex-col overflow-hidden border-l border-base-300/60 bg-base-100 shadow-overlay outline-none transition-transform sm:max-w-[520px] motion-reduce:transition-none"
        ...
        >
          <header
            class="surface-chrome flex min-h-[4.5rem] shrink-0 items-center gap-3 border-b border-base-300/60 px-5 py-3"
          >
