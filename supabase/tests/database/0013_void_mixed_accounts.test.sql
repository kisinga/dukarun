...
values ('11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'admin@void.local', '', now(), now());
...
create temp table vd_claims as
...
from vd_company;
grant select on pg_temp.vd_claims to authenticated;

set local role authenticated;
select set_config('request.jwt.claims', (select claims from vd_claims), true);
