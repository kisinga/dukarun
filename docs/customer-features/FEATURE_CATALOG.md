...
| Recognition enrollment data                  | Store product image embeddings and cache them for POS recognition.                                                  | Operators, integrators       | Dukarun-Exclusive | [ML & Intelligence](./ml-and-intelligence.md#enrollment-model)                          |
...
| Product-level recognition enrollment              | Each product stores embeddings produced from its own label photos.                                                  | Operators, larger retailers         | Dukarun-Exclusive | [ML & Intelligence](./ml-and-intelligence.md#enrollment-model)        |
| Offline fingerprint caching                       | Product fingerprints are cached with the POS catalog for fast offline matching.                                     | Cashiers                            | Dukarun-Exclusive | [ML & Intelligence](./ml-and-intelligence.md#offline-first-pos-intelligence) |
