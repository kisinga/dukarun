...
import { GET_PRODUCT, SEARCH_BY_BARCODE, SEARCH_PRODUCTS } from '@dukarun/product-search';
import { GET_PRODUCTS } from '../operations.graphql';
import type { GetProductsQuery } from '../../../shared/graphql/generated/graphql';
