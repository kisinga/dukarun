...
export type AnalyticsStatsForChannelQueryVariables = Exact<{
  channelId: Scalars['ID']['input'];
  timeRange: AnalyticsTimeRange;
  limit?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type AnalyticsStatsForChannelQuery = { __typename?: 'Query', analyticsStatsForChannel: { __typename?: 'AnalyticsStats', totalRevenue: number, totalOrders: number, averageProfitMargin: number, salesTrend: Array<{ __typename?: 'TimeSeriesPoint', date: string, value: number }>, orderVolumeTrend: Array<{ __typename?: 'TimeSeriesPoint', date: string, value: number }>, customerGrowthTrend: Array<{ __typename?: 'TimeSeriesPoint', date: string, value: number }> } };

export type AuditLogsForChannelQueryVariables = Exact<{
  channelId: Scalars['ID']['input'];
  options?: InputMaybe<AuditLogOptions>;
}>;


export type AuditLogsForChannelQuery = { __typename?: 'Query', auditLogsForChannel: Array<{ __typename?: 'AuditLog', id: string, timestamp: any, eventType: string, entityType?: string | null, entityId?: string | null, userId?: string | null, data: any }> };
...
export type UpdateChannelZonesPlatformMutation = { __typename?: 'Mutation', updateChannelZonesPlatform: { __typename?: 'Channel', id: string } };

export type UpdateChannelStatusPlatformMutationVariables = Exact<{
  channelId: Scalars['ID']['input'];
  status: Scalars['String']['input'];
}>;


export type UpdateChannelStatusPlatformMutation = { __typename?: 'Mutation', updateChannelStatusPlatform: { __typename?: 'Channel', id: string, customFields?: { __typename?: 'ChannelCustomFields', status?: string | null } | null } };
...
export type UpdateChannelFeatureFlagsPlatformMutation = { __typename?: 'Mutation', updateChannelFeatureFlagsPlatform: { __typename?: 'Channel', id: string, customFields?: { __typename?: 'ChannelCustomFields', cashierFlowEnabled?: boolean | null, cashControlEnabled?: boolean | null, enablePrinter?: boolean | null } | null } };

export type UpdateChannelPublicStorefrontPlatformMutationVariables = Exact<{
  input: UpdateChannelPublicStorefrontInput;
}>;


export type UpdateChannelPublicStorefrontPlatformMutation = { __typename?: 'Mutation', updateChannelPublicStorefrontPlatform: { __typename?: 'Channel', id: string, customFields?: { __typename?: 'ChannelCustomFields', publicStorefrontEnabled?: boolean | null, publicSlug?: string | null, publicWhatsAppNumber?: string | null } | null } };
...
export type SendTestCustomerNotificationMutationVariables = Exact<{
  channelId: Scalars['ID']['input'];
  customerId: Scalars['ID']['input'];
  triggerKey: Scalars['String']['input'];
}>;
...
export type SendTestWhatsAppNotificationMutation = { __typename?: 'Mutation', sendTestWhatsAppNotification: { __typename?: 'SendTestNotificationResult', success: boolean, channel?: string | null, error?: string | null, info?: string | null } };

export type NotificationsForChannelQueryVariables = Exact<{
  channelId: Scalars['ID']['input'];
  options?: InputMaybe<NotificationListOptions>;
}>;


export type NotificationsForChannelQuery = { __typename?: 'Query', notificationsForChannel: { __typename?: 'NotificationList', totalItems: number, items: Array<{ __typename?: 'Notification', id: string, userId: string, channelId: string, type: NotificationType, title: string, message: string, read: boolean, createdAt: any }> } };
...
export type PlatformZonesQueryVariables = Exact<{ [key: string]: never; }>;


export type PlatformZonesQuery = { __typename?: 'Query', platformZones: Array<{ __typename?: 'PlatformZone', id: string, name: string }> };

export type PlatformMonitoringQueryVariables = Exact<{ [key: string]: never; }>;


export type PlatformMonitoringQuery = { __typename?: 'Query', platformMonitoring: { __typename?: 'PlatformMonitoring', uptimeSeconds: number, loadAvg: Array<number>, processMemory: { __typename?: 'ProcessMemory', heapUsedMB: number, heapTotalMB: number, rssMB: number }, systemMemory: { __typename?: 'SystemMemory', totalMB: number, freeMB: number, usedMB: number }, services: Array<{ __typename?: 'ServiceHealth', name: string, status: string, error?: string | null }> } };

export type PlatformStatsQueryVariables = Exact<{ [key: string]: never; }>;


export type PlatformStatsQuery = { __typename?: 'Query', platformStats: { __typename?: 'PlatformStats', totalChannels: number, trialExpiringSoonCount: number, activeSubscriptionsCount: number, channelsByStatus: { __typename?: 'ChannelsByStatus', UNAPPROVED: number, APPROVED: number, DISABLED: number, BANNED: number } } };
...
export type PlatformAdministratorsQueryVariables = Exact<{
  options?: InputMaybe<PlatformAdministratorListOptions>;
}>;


export type PlatformAdministratorsQuery = { __typename?: 'Query', platformAdministrators: { __typename?: 'PlatformAdministratorList', totalItems: number, items: Array<{ __typename?: 'PlatformAdministrator', id: string, firstName: string, lastName: string, emailAddress: string, userId: string, identifier: string, authorizationStatus: string, roleCodes: Array<string>, channelIds?: Array<string> | null, isSuperAdmin?: boolean | null }> } };
...
export type PendingRegistrationsQueryVariables = Exact<{ [key: string]: never; }>;


export type PendingRegistrationsQuery = { __typename?: 'Query', pendingRegistrations: Array<{ __typename?: 'PendingRegistration', userId: string, identifier: string, createdAt: any, administrator: { __typename?: 'PendingRegistrationAdministrator', id: string, firstName: string, lastName: string, emailAddress: string } }> };

export type RegistrationSeedContextQueryVariables = Exact<{ [key: string]: never; }>;


export type RegistrationSeedContextQuery = { __typename?: 'Query', registrationSeedContext: { __typename?: 'RegistrationSeedContext', zone: { __typename?: 'RegistrationZone', id: string, name: string, members: Array<{ __typename?: 'RegistrationZoneMember', id: string, name: string, code: string }> }, taxRate?: { __typename?: 'RegistrationTaxRate', id: string, name: string, categoryName: string, value: number } | null } };

export type UpdateRegistrationTaxRateMutationVariables = Exact<{
  input: UpdateRegistrationTaxRateInput;
}>;


export type UpdateRegistrationTaxRateMutation = { __typename?: 'Mutation', updateRegistrationTaxRate: { __typename?: 'RegistrationTaxRate', id: string, name: string, categoryName: string, value: number } };

export type PlatformRoleTemplatesQueryVariables = Exact<{ [key: string]: never; }>;


export type PlatformRoleTemplatesQuery = { __typename?: 'Query', platformRoleTemplates: Array<{ __typename?: 'PlatformRoleTemplate', id: string, code: string, name: string, description?: string | null, permissions: Array<string> }> };

export type AssignablePermissionsQueryVariables = Exact<{ [key: string]: never; }>;


export type AssignablePermissionsQuery = { __typename?: 'Query', assignablePermissions: Array<string> };
...
export type CreateRoleTemplateMutation = { __typename?: 'Mutation', createRoleTemplate: { __typename?: 'PlatformRoleTemplate', id: string, code: string, name: string, description?: string | null, permissions: Array<string> } };
...
export type UpdateRoleTemplateMutation = { __typename?: 'Mutation', updateRoleTemplate: { __typename?: 'PlatformRoleTemplate', id: string, code: string, name: string, description?: string | null, permissions: Array<string> } };
...
export type DeleteRoleTemplateMutation = { __typename?: 'Mutation', deleteRoleTemplate: boolean };

export type GetSubscriptionTiersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSubscriptionTiersQuery = { __typename?: 'Query', getSubscriptionTiers: Array<{ __typename?: 'SubscriptionTier', id: string, code: string, name: string, description?: string | null, priceMonthly: number, priceYearly: number, features?: any | null, limits?: any | null, isActive: boolean, createdAt: any, updatedAt: any }> };
...
export type CreateSubscriptionTierMutation = { __typename?: 'Mutation', createSubscriptionTier: { __typename?: 'SubscriptionTier', id: string, code: string, name: string, priceMonthly: number, priceYearly: number, limits?: any | null, isActive: boolean } };
...
export type UpdateSubscriptionTierMutation = { __typename?: 'Mutation', updateSubscriptionTier: { __typename?: 'SubscriptionTier', id: string, code: string, name: string, priceMonthly: number, priceYearly: number, limits?: any | null, isActive: boolean } };
...
export type DeactivateSubscriptionTierMutation = { __typename?: 'Mutation', deactivateSubscriptionTier: boolean };

export type ExtendTrialPlatformMutationVariables = Exact<{
  channelId: Scalars['ID']['input'];
  trialEndsAt: Scalars['DateTime']['input'];
}>;
...
export type AdministratorsForChannelQueryVariables = Exact<{
  channelId: Scalars['ID']['input'];
}>;


export type AdministratorsForChannelQuery = { __typename?: 'Query', administratorsForChannel: Array<{ __typename?: 'PlatformAdministrator', id: string, firstName: string, lastName: string, emailAddress: string, userId: string, identifier: string, authorizationStatus: string, roleCodes: Array<string> }> };

export type AdministratorDetailQueryVariables = Exact<{
  administratorId: Scalars['ID']['input'];
}>;


export type AdministratorDetailQuery = { __typename?: 'Query', administratorDetail?: { __typename?: 'PlatformAdministratorDetail', id: string, firstName: string, lastName: string, emailAddress: string, userId: string, identifier: string, authorizationStatus: string, isSuperAdmin: boolean, roles: Array<{ __typename?: 'PlatformAdministratorRoleDetail', id: string, code: string, channelIds: Array<string>, permissions: Array<string> }> } | null };
...
export type ApproveUserMutation = { __typename?: 'Mutation', approveUser: { __typename?: 'UserAuthorizationResult', id: string, identifier: string, authorizationStatus: string } };
...
export type UpdateAdministratorPermissionsMutationVariables = Exact<{
  administratorId: Scalars['ID']['input'];
  channelId: Scalars['ID']['input'];
...
export type AdminLoginAttemptsQuery = { __typename?: 'Query', adminLoginAttempts: Array<{ __typename?: 'AdminLoginAttempt', id: string, eventKind: string, timestamp: any, ipAddress?: string | null, username: string, success: boolean, failureReason?: string | null, userId?: number | null, authMethod: string, userAgent?: string | null, isSuperAdmin?: boolean | null }> };


export const AnalyticsStatsForChannelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AnalyticsStatsForChannel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"channelId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"timeRange"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AnalyticsTimeRange"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"analyticsStatsForChannel"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"channelId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"channelId"}}},{"kind":"Argument","name":{"kind":"Name","value":"timeRange"},"value":{"kind":"Variable","name":{"kind":"Name","value":"timeRange"}}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"totalRevenue"}},{"kind":"Field","name":{"kind":"Name","value":"totalOrders"}},{"kind":"Field","name":{"kind":"Name","value":"averageProfitMargin"}},{"kind":"Field","name":{"kind":"Name","value":"salesTrend"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"orderVolumeTrend"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"customerGrowthTrend"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]} as unknown as DocumentNode<AnalyticsStatsForChannelQuery, AnalyticsStatsForChannelQueryVariables>;
...
export const NotificationsForChannelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"NotificationsForChannel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"channelId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"options"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"NotificationListOptions"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"notificationsForChannel"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"channelId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"channelId"}}},{"kind":"Argument","name":{"kind":"Name","value":"options"},"value":{"kind":"Variable","name":{"kind":"Name","value":"options"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"channelId"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"read"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalItems"}}]}}]}}]} as unknown as DocumentNode<NotificationsForChannelQuery, NotificationsForChannelQueryVariables>;
...
export const UpdateRoleTemplateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateRoleTemplate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateRoleTemplateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateRoleTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"permissions"}}]}}]}}]} as unknown as DocumentNode<UpdateRoleTemplateMutation, UpdateRoleTemplateMutationVariables>;
...
export const DeactivateSubscriptionTierDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeactivateSubscriptionTier"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deactivateSubscriptionTier"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<DeactivateSubscriptionTierMutation, DeactivateSubscriptionTierMutationVariables>;
