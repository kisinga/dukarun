...
if [ "$SYNC_FUNCTIONS" = "1" ]; then
  ...
  for fn in _shared paystack-charge paystack-webhook mpesa-initiate mpesa-callback mpesa-process mpesa-credentials notification-flush platform-message-test platform-sales-invitation-send public-content-renderer site-deploy; do
