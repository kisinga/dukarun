...
if (ci === -1) { console.error('usage: node scripts/etl/export-map.mjs --channel <id>'); process.exit(1); }
...
for (const r of rows) lines.push([r.old_type, r.old_id, r.company_id, r.new_id].map(csvCell).join(','));
