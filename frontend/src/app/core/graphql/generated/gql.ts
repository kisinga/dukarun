...
type Documents = {
  ...
  '\n  query GetPlatformMetrics {\n    platformMetrics {\n      onlineUsers\n      mau\n    }\n  }\n': typeof types.GetPlatformMetricsDocument;
  ...
  '\n  mutation UpdateBatchExpirySettings($batchExpiryEnabled: Boolean, $lowStockThreshold: Int) {\n    updateBatchExpirySettings(batchExpiryEnabled: $batchExpiryEnabled, lowStockThreshold: $lowStockThreshold) {\n      cashierFlowEnabled\n      batchExpiryEnabled\n      lowStockThreshold\n      enablePrinter\n      companyLogoAsset {\n        id\n        preview\n        source\n      }\n    }\n  }\n': typeof types.UpdateBatchExpirySettingsDocument;
...
const documents: Documents = {
  ...
  '\n  query GetProductsByInventoryAlert($filter: InventoryAlertFilter!, $options: ProductListOptions) {\n    productsByInventoryAlert(filter: $filter, options: $options) {\n      totalItems\n      items {\n        id\n        name\n        slug\n        description\n        enabled\n        featuredAsset {\n          id\n          preview\n        }\n        facetValues {\n          id\n          name\n          facet {\n            code\n          }\n        }\n        variants {\n          id\n          name\n          sku\n          price\n          priceWithTax\n          stockOnHand\n          trackInventory\n          customFields {\n            wholesalePrice\n            allowFractionalQuantity\n          }\n          prices {\n            price\n            currencyCode\n          }\n          inventoryBatches {\n            id\n            quantity\n            expiryDate\n            batchNumber\n            consumePriority\n          }\n        }\n      }\n    }\n  }\n':
    types.GetProductsByInventoryAlertDocument,
  '\n  mutation DeleteProduct($id: ID!) {\n    deleteProduct(id: $id) {\n      result\n      message\n    }\n  }\n':
  ...
  '\n  query GetPlatformMetrics {\n    platformMetrics {\n      onlineUsers\n      mau\n    }\n  }\n':
    types.GetPlatformMetricsDocument,
  '\n  query GetStockValueStats($stockLocationId: ID, $forceRefresh: Boolean) {\n    stockValueStats(stockLocationId: $stockLocationId, forceRefresh: $forceRefresh) {\n      retail\n      wholesale\n      cost\n    }\n  }\n':
    types.GetStockValueStatsDocument,
  '\n  query GetInventoryAlerts($expiryThresholdDays: Int) {\n    inventoryAlerts(expiryThresholdDays: $expiryThresholdDays) {\n      lowStockCount\n      expiringSoonCount\n      expiredCount\n    }\n  }\n':
    types.GetInventoryAlertsDocument,
  '\n  query GetStockValueRanking(\n    $valuationType: StockValuationType!\n    $limit: Int\n    $stockLocationId: ID\n  ) {\n    stockValueRanking(\n      valuationType: $valuationType\n      limit: $limit\n      stockLocationId: $stockLocationId\n    ) {\n      items {\n        productVariantId\n        productId\n        productName\n        variantName\n        value\n      }\n      total\n    }\n  }\n':
  ...
  '\n  mutation DeleteDraftOrder($orderId: ID!) {\n    deleteDraftOrder(orderId: $orderId) {\n      result\n      message\n    }\n  }\n':
    types.DeleteDraftOrderDocument,
  '\n  mutation AdjustDraftOrderLine($orderId: ID!, $input: AdjustDraftOrderLineInput!) {\n    adjustDraftOrderLine(orderId: $orderId, input: $input) {\n      ... on Order {\n        id\n        code\n        state\n        total\n        totalWithTax\n        lines {\n          id\n          quantity\n          linePrice\n          linePriceWithTax\n          productVariant {\n            id\n            name\n          }\n        }\n      }\n    }\n  }\n':
  ...
  '\n  mutation ReversePayment($paymentId: ID!) {\n    reversePayment(paymentId: $paymentId) {\n      paymentId\n      reversedAmount\n      orderNowUnderpaid\n    }\n  }\n':
    types.ReversePaymentDocument,
  '\n  mutation OverrideCustomerBalance($input: OverrideCustomerBalanceInput!) {\n    overrideCustomerBalance(input: $input) {\n      customerId\n      previousBalance\n      newBalance\n      adjustmentAmount\n    }\n  }\n':
    types.OverrideCustomerBalanceDocument,
  '\n  mutation AddFulfillmentToOrder($input: FulfillOrderInput!) {\n    addFulfillmentToOrder(input: $input) {\n      ... on Fulfillment {\n        id\n        state\n        nextStates\n        createdAt\n        updatedAt\n        method\n        lines {\n          orderLineId\n          quantity\n        }\n        trackingCode\n      }\n      ... on CreateFulfillmentError {\n        errorCode\n        message\n        fulfillmentHandlerError\n      }\n      ... on FulfillmentStateTransitionError {\n        errorCode\n        message\n        transitionError\n      }\n    }\n  }\n':
  ...
  '\n  query OrderPaymentStatus($orderId: ID!) {\n    orderPaymentStatus(orderId: $orderId) {\n      totalOwed\n      amountPaid\n      amountOwing\n    }\n  }\n':
    types.OrderPaymentStatusDocument,
  '\n  mutation RecordPayment($input: RecordPaymentInput!) {\n    recordPayment(input: $input) {\n      ordersPaid {\n        orderId\n        orderCode\n        amountPaid\n      }\n      remainingBalance\n      totalAllocated\n    }\n  }\n':
  ...
  '\n  mutation UpdateBatchExpirySettings($batchExpiryEnabled: Boolean, $lowStockThreshold: Int) {\n    updateBatchExpirySettings(batchExpiryEnabled: $batchExpiryEnabled, lowStockThreshold: $lowStockThreshold) {\n      cashierFlowEnabled\n      batchExpiryEnabled\n      lowStockThreshold\n      enablePrinter\n      companyLogoAsset {\n        id\n        preview\n        source\n      }\n    }\n  }\n':
    types.UpdateBatchExpirySettingsDocument,
  '\n  mutation UpdatePrinterSettings($enablePrinter: Boolean!) {\n    updatePrinterSettings(enablePrinter: $enablePrinter) {\n      cashierFlowEnabled\n      batchExpiryEnabled\n      lowStockThreshold\n      enablePrinter\n      companyLogoAsset {\n        id\n        preview\n        source\n      }\n    }\n  }\n':
  ...
  '\n  query ChannelNotificationPreferences {\n    channelNotificationPreferences {\n      customer\n      orders\n      stock\n      finance\n      operations\n    }\n  }\n':
    types.ChannelNotificationPreferencesDocument,
  '\n  mutation UpdateChannelNotificationPreferences($input: ChannelNotificationPreferencesInput!) {\n    updateChannelNotificationPreferences(input: $input) {\n      customer\n      orders\n      stock\n      finance\n      operations\n    }\n  }\n':
