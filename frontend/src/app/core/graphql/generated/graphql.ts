...
export type GetProductQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, featuredAsset?: { __typename?: 'Asset', preview: string } | null, facetValues: Array<{ __typename?: 'FacetValue', id: string, name: string, facet: { __typename?: 'Facet', code: string } }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, sku: string, price: number, priceWithTax: number, trackInventory: GlobalFlag, prices: Array<{ __typename?: 'ProductVariantPrice', price: number, currencyCode: CurrencyCode }>, stockLevels: Array<{ __typename?: 'StockLevel', stockLocationId: string, stockOnHand: number }>, customFields?: { __typename?: 'ProductVariantCustomFields', wholesalePrice?: number | null, allowFractionalQuantity?: boolean | null } | null }> } | null };
...
export type GetVariantStockLevelQuery = { __typename?: 'Query', productVariant?: { __typename?: 'ProductVariant', id: string, name: string, sku: string, stockOnHand: number, stockLevels: Array<{ __typename?: 'StockLevel', id: string, stockOnHand: number, stockLocation: { __typename?: 'StockLocation', id: string, name: string } }> } | null };
...
export type SendCustomerStatementSmsMutation = { __typename?: 'Mutation', sendCustomerStatementSms: boolean };
...
export const SendCustomerStatementSmsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SendCustomerStatementSms"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sendCustomerStatementSms"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"customerId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"customerId"}}}]}]}}]} as unknown as DocumentNode<SendCustomerStatementSmsMutation, SendCustomerStatementSmsMutationVariables>;
