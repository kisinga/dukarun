...
| `frontend/src/app/domains/approval/services/approval.service.ts` | Frontend API service |
| `frontend/src/app/pages/approvals/approvals.component.ts` | Approvals list page |
| `frontend/src/app/shared/components/dashboard-shared/directives/approvable-form-base.directive.ts` | Form base directive |
| `frontend/src/app/shared/components/dashboard-shared/components/rejection-banner.component.ts` | Rejection banner |
