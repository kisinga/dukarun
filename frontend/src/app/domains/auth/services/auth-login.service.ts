...
import { LOGIN, LOGOUT } from '../operations.graphql';
import type { LoginMutation, LoginMutationVariables } from '../../../shared/models/user.model';
import { formatPhoneNumber } from '../../../shared/utils/phone.utils';
import { ApolloService } from '../../../shared/services/apollo.service';
import { APP_CACHE_RESET, COMPANY_CONTEXT } from '../../../shared/services/app-context.tokens';
...
export class AuthLoginService {
  ...
  private readonly appCacheReset = inject(APP_CACHE_RESET);
    ...
    try {
      ...
      if (loginResult?.__typename === 'CurrentUser') {
        ...
        if (loginResult.channels && loginResult.channels.length > 0) {
          this.companyContext.setCompaniesFromChannels(loginResult.channels);
        }
