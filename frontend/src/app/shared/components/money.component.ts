...
import { FINANCIAL_ACCESS } from '../services/app-context.tokens';
...
export class MoneyComponent {
  ...
  private readonly financialAccess = inject(FINANCIAL_ACCESS);
  ...
  readonly masked = computed(() => this.sensitive() && !this.financialAccess.canViewFinancials());
